...
PRAGMA EXCEPTION_INIT (E_CUST_NOT_FOUND, -20010);
PRAGMA EXCEPTION_INIT (E_CARD_INFORMATION_NC, -20011);
PRAGMA EXCEPTION_INIT (E_CARD_EXPIRING, -20012);
PRAGMA EXCEPTION_INIT (E_CARD_EXPIRED, -20013);
