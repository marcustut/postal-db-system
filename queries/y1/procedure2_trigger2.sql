...
PRAGMA EXCEPTION_INIT (E_CUST_NOT_FOUND, -20014);
PRAGMA EXCEPTION_INIT (E_PARCEL_NOT_FOUND, -20015);
PRAGMA EXCEPTION_INIT (E_METHOD_NOT_FOUND, -20016);
PRAGMA EXCEPTION_INIT (E_INSURANCE_NOT_FOUND, -20017);
o_date DATE;
